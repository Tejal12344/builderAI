...
const HomePage = () => {
  ...
  const{user,projects,loadingProjects,generatingProject,loadProjects,handleGenerate,
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8 xl:mt-28">
       <div className='w-full max-w-2xl flex flex-col items-center'>
        ...
        backdrop-blur-md rounded-full border border-white/20 text-[13px] text-white/90'>
          <span className="px-3 py-1 text-[11px] bg-red-700 rounded-full font-medium
          tracking-wider">PROMO</span>
          <span>
        ...
        <p className='text-center text-sm md:text-base max-w-xl mt-4 text-white/65
         leading-relaxed'>
         Describe your idea and watch AI design,structure,and launch the website 
